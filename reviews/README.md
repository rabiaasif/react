...
I've used this api once before for work purposes! Recently talked about using it with something I thought it would be fun to make a simple map so I went over to https://developers.google.com/maps/documentation/javascript/tutorial and just followed some of the simple steps to mak my own map! 
You can get your own API key on the GOOGLE console!
